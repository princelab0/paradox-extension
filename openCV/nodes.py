...
class ReadImage(NodeBase):
    ...
    def update_event(self, inp=-1):
        ...
        try:
            ...
            self.set_output_val(1, self.image_filepath)
...
# class DisplayPro(OpenCVNodeBase):
#     title = 'Display Protein'
#     init_inputs = [
#         NodeInputBP('PDB file'),
#     ]

#     def get_img(self):
#         pdbWidget = PDBVisualizer(500, 500, self.input(0))
#         return pdbWidget
...
class MyHistogram(NodeBase):
    title = 'myhistogram'
    init_inputs = [
        NodeInputBP('x'),
        NodeInputBP('y'),
    ]
    main_widget_class = widgets.MyHistogramView
    main_widget_pos = 'below ports'
