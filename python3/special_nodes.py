...
# Block for the Arduino Board
class Arduino_Node(DualNodeBase):
    ...
    def arduino_func(self):
        # function for the ardunio 
        awake_time = self.input(1)
        sleep_time = self.input(2)
        Pin = self.input(3)
        Port = self.input(4)
